...
#    1001 = OC/TT
#    1002 = DC
GeneralCard = [1002, 1000, 1001, 1000, 1000, 1000, 1002, 1002, 1000, 1002, 1000]
...
[   {'MOVE_TYPE': 1010, 'MOVE_NAME': 'ROPES'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'BELLY DROP'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'AVALANCHE'},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'CHOKE WITH FOOT'},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'FOREARMS'},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'ELBOW TO THROAT'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1009, 'MOVE_NAME': 'RAM INTO RING POST'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'BELLY BUMP'},
    {'MOVE_TYPE': 1006, 'MOVE_NAME': 'THROW THRU ROPES'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'BUTT DROP'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1004, 'MOVE_NAME': 'BEARHUG'}]
...
DefensiveCard = [5, 2, 4, 2, 0, 0, 0, 2, 0, 2, 2]

# Specialty Card Definitions:
#    1003 = Pin attempt move (P/A)
#    1004 = Submission Move (*)
#    1005 = Specialty Move (S)
Specialty = {   'AVALANCHE': [   {'MOVE_POINTS': 12, 'MOVE_TYPE': 1005},
