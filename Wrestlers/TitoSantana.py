...
#    1001 = OC/TT
#    1002 = DC
GeneralCard = [1002, 1000, 1002, 1000, 1000, 1000, 1001, 1000, 1002, 1002, 1002]
...
[   {'MOVE_TYPE': 1010, 'MOVE_NAME': 'ROPES'},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'MEXICAN SUPLEX'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1009, 'MOVE_NAME': 'MULE KICK'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'SIDE HEADLOCK'},
    {   'MOVE_NAME': 'JUMPING BEAN DROPKICK',
        'MOVE_POINTS': 9,
        'MOVE_TYPE': 1008},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'ARMBAR'},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'LEG-DIVE TAKEDOWN'},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'JALAPENO SMASH'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'FIGURE-FOUR TOEHOLD'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'ABDOMINAL STRETCH'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'FLYING BODYPRESS'}]
...
DefensiveCard = [0, 0, 2, 4, 2, 2, 5, 2, 2, 0, 0]

# Specialty Card Definitions:
#    1003 = Pin attempt move (P/A)
#    1004 = Submission Move (*)
#    1005 = Specialty Move (S)
Specialty = {   'FIGURE-FOUR TOEHOLD': [   {'MOVE_POINTS': 12, 'MOVE_TYPE': 1005},
...
#    1014 = No Action (NA)
Ropes = \
[   {'MOVE_POINTS': 8, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'REVERSE CRADLE'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 10, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'FLYING SLINGSHOT'},
    {'MOVE_POINTS': 10, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'FLYING SLINGSHOT'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'FLYING SLINGSHOT'},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'MEXICAN SUPLEX'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'REVERSE CRADLE'}]
