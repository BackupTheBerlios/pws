...
#    1001 = OC/TT
#    1002 = DC
GeneralCard = [1000, 1002, 1002, 1000, 1000, 1001, 1000, 1002, 1002, 1000, 1002]
...
OffensiveCard = \
[   {'MOVE_POINTS': 5, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'FRONT CHANCERY'},
    {'MOVE_POINTS': 10, 'MOVE_TYPE': 1009, 'MOVE_NAME': 'FIREMAN CARRY'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'AIRPLANE SPIN'},
    {'MOVE_POINTS': 10, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'FRONTAL SUPLEX'},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'REVERSE NELSON'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'STANDING ARMBAR'},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'DOUBLE DROPKICK'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'DROP TOEHOLD'},
    {'MOVE_POINTS': 5, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'LEG DIVE TAKE-DOWN'},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'REVERSE CRADLE'},
...
#    1004 = Submission Move (*)
#    1005 = Specialty Move (S)
Specialty = {   'AIRPLANE SPIN': [   {'MOVE_POINTS': 14, 'MOVE_TYPE': 1005},
                         {'MOVE_POINTS': 1, 'MOVE_TYPE': 1005},
...
#    1014 = No Action (NA)
Ropes = \
[   {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'DROPKICKS'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'SPIN UNDER TAKE-DOWN'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
