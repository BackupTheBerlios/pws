...
#    1001 = OC/TT
#    1002 = DC
GeneralCard = [1002, 1002, 1002, 1000, 1000, 1000, 1000, 1001, 1002, 1002, 1000]
...
[   {'MOVE_TYPE': 1010, 'MOVE_NAME': 'ROPES'},
    {   'MOVE_NAME': 'FLYING HEAD SCISSORS',
        'MOVE_POINTS': 10,
        'MOVE_TYPE': 1008},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1009, 'MOVE_NAME': 'CROSS HIPLOCK'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'HEADLOCK'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'RAPID FIRE DROPKICKS'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'BODYSLAM'},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'MONKEY FLIP'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'FLYING CROSS BODYBLOCK'},
    {'MOVE_POINTS': 8, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'CANADIAN SUPLEX'},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'BOSTON CRAB'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1004, 'MOVE_NAME': 'ABDOMINAL STRETCH'}]
...
DefensiveCard = [0, 0, 2, 4, 2, 5, 2, 2, 0, 2, 0]

# Specialty Card Definitions:
#    1003 = Pin attempt move (P/A)
#    1004 = Submission Move (*)
#    1005 = Specialty Move (S)
Specialty = {   'FLYING CROSS BODYBLOCK': [   {'MOVE_POINTS': 8, 'MOVE_TYPE': 1003},
...
[   {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 10, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'SMALL PACKAGE'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'FLYING CROSS BODYBLOCK'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'FLYING CROSS BODYBLOCK'},
    {'MOVE_POINTS': 5, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'SHOULDER BUTT'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'REVERSE CRADLE'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'BACKDROP'}]
