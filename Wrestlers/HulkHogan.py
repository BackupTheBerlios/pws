...
#    1001 = OC/TT
#    1002 = DC
GeneralCard = [1002, 1000, 1002, 1000, 1000, 1000, 1000, 1002, 1001, 1002, 1002]
...
[   {'MOVE_TYPE': 1010, 'MOVE_NAME': 'ROPES'},
    ...
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'THROAT LIFT'},
    {'MOVE_POINTS': 10, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'PYTHON HEADLOCK'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1009, 'MOVE_NAME': 'POWER FOREARMS'},
    {'MOVE_POINTS': 7, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'CRUSHING LEGLOCK'},
    ...
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'THUNDER SLAM'},
    {'MOVE_POINTS': 6, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'PSYCHE UP CROWD'}]
...
DefensiveCard = [0, 0, 2, 5, 0, 2, 4, 2, 2, 0, 0]

# Specialty Card Definitions:
#    1003 = Pin attempt move (P/A)
#    1004 = Submission Move (*)
#    1005 = Specialty Move (S)
Specialty = {   'LEG DROP': [   {'MOVE_POINTS': 9, 'MOVE_TYPE': 1003},
...
[   {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1003, 'MOVE_NAME': 'SCOOP & SLAM'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'LEG DROP'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'LEG DROP'},
    {'MOVE_TYPE': 1005, 'MOVE_NAME': 'LEG DROP'},
    {'MOVE_POINTS': 9, 'MOVE_TYPE': 1008, 'MOVE_NAME': 'ELBOW SMASH'},
    {'MOVE_POINTS': 10, 'MOVE_TYPE': 1004, 'MOVE_NAME': 'BEARHUG'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'},
    {'MOVE_POINTS': 0, 'MOVE_TYPE': 1014, 'MOVE_NAME': 'NA'}]
